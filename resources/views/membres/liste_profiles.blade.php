...
@section('content')
    ...
    <div class="content">
        <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class=" active">Listes des Groupes</li>
          </ol>
        </nav>
        <h2 class="text-bold text-1100 mb-5">Liste des Groupes</h2>
          ...
          <div class="row align-items-center justify-content-between g-3 mb-4">
            ...
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    ...
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#profils">Add Groups</button>
                    @endif
                </div>
                @include('membres.addProfil-modal')
            </div>
                ...
                <div class="table-responsive scrollbar ms-n1 ps-1">
                    <table class="table table-sm fs--1 mb-0">
                        ...
                        <tr>
                            ...
                            <th class="sort align-middle" scope="col" data-sort="customer" style="width:35%; min-width:200px;">NOMS</th>
                            <th class="sort align-middle" scope="col" data-sort="email" style="width:35%; min-width:200px;">Nombre de Membres</th>
                            @if(Auth::user()->profil->nom_profil == 'President' || Auth::user()->profil->nom_profil == 'Secretaire')
                            <th class="sort align-middle" scope="col" data-sort="email" style="width:25%; min-width:200px;">SUPPRIMER</th>
                            @endif
                            </tr>
                        </thead>
                        <tbody class="list" id="members-table-body">
                            @foreach ($profils as $profils)
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="customer align-middle white-space-nowrap"><a class="d-flex align-items-center text-900 text-hover-1000" href="{{route('membre', $profils->id)}}">{{ $profils->nom_profil }}</a></td>
                                    <td class="city align-middle white-space-nowrap text-900">{{ $nombreMembre }}</td>
            ...
            <div class="d-flex align-items-center">
                <input class="btn btn-primary" value ="All Members" type="button" onclick="moreInfo()">
            </div>
        </div>
    </div>
    ...
    <div class="content" id="listeMembre" style="display: none;">
    ...
    <script>
        ...
        function moreInfo() {
            var formulaire = document.getElementById("listeMembre");
