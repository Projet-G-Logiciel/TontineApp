...
<div class="content">
  <nav class="mb-2" aria-label="breadcrumb">
    <ol class="breadcrumb mb-0">
      ...
      <li class=" active">Rapport seance 2</li>
    </ol>
  </nav>
  <h2 class="text-bold text-1100 mb-5">Les Rapports de la seance 2</h2>

<div id="choix1">
<h2 class="text-bold text-1100 mb-5">Rapports Cotisation</h2>
                ...
                <tbody class="list" id="members-table-body">
                    @foreach ($cotisations as $cotisation)
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="customer align-middle white-space-nowrap"><a class="d-flex align-items-center text-900 text-hover-1000" href="#!">{{ $cotisation->name }}</a></td>
                            <td class="email align-middle white-space-nowrap"><a class="fw-semi-bold" href="mailto:annac34@gmail.com">{{$cotisation->montant}}</a></td>

                            <td class="city align-middle white-space-nowrap text-900">{{$cotisation->created_at}}</td>
                        </tr>
...
<div id="choix2">
    <h2 class="text-bold text-1100 mb-5">Rapports Epargne</h2>
            <div id="members" data-list='{"valueNames":["customer","email","mobile_number","city","last_active","joined"],"page":10,"pagination":true}'>
              <div class="row align-items-center justify-content-between g-3 mb-4">
                <div class="col col-auto">
                  <div class="search-box">
                    ...
                    <tbody class="list" id="members-table-body">
                        @foreach ($epargnes as $epargne)
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                ...
                                <td class="customer align-middle white-space-nowrap"><a class="d-flex align-items-center text-900 text-hover-1000" href="#!">{{ $epargne->name }}</a></td>
                                <td class="email align-middle white-space-nowrap"><a class="fw-semi-bold" href="mailto:annac34@gmail.com">{{$epargne->montant}}</a></td>

                                <td class="city align-middle white-space-nowrap text-900">{{$epargne->created_at}}</td>
                            </tr>
    ...
    <div id="choix3">
        <h2 class="text-bold text-1100 mb-5">Rapports Emprunt</h2>
                <div id="members" data-list='{"valueNames":["customer","email","mobile_number","city","last_active","joined"],"page":10,"pagination":true}'>
                  <div class="row align-items-center justify-content-between g-3 mb-4">
                    <div class="col col-auto">
                      <div class="search-box">
