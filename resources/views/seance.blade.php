                ...
                <div class="card m-3 col-md-5">
                    ...
                    <div class="card-body col-12 col-md-9">
                        <div class="col-md-12 mb-3">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" {{ $i == 0 ? '' : 'disabled'}} data-bs-target="#cotisation"> Cotisation </button> <br>
                        </div>
                        <div class="col-md-12">
                            <label for="text-input" class=" form-control-label">Argent de l'epargne</label> <br>
                            <button class="btn btn-primary" type="button" data-bs-toggle="modal" {{ $i == 0 ? '' : 'disabled'}} data-bs-target="#epargne"> Epargne </button>
                        </div>
                    </div>
                </div>
